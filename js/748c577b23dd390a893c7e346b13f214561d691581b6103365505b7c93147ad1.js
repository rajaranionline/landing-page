        ...
        e.forEach((e=>{
            ...
            const r = {}
              , {maybeResetVideoProgress: s, videoStart: d} = function(e, t) {
                ...
                e.addEventListener("timeupdate", (()=>{
                    ...
                    let n;
                    null != r && t >= r - (a ? .25 : 0) ? e.loop || e.dataset.loop ? (n = i,
                ...
                const s = ()=>{
                    ...
                    null === (n = t.updateDuration) || void 0 === n || n.call(t, i, r))
                }
                ;
            ...
            const l = null !== (o = e.closest(".video_container")) && void 0 !== o ? o : (null !== (i = e.closest("svg")) && void 0 !== i ? i : e).closest("div")
              , {onResizeCallback: c} = function(e, t, n, o, i) {
                ...
                t.controls = !1;
                const {seekBar: s, updateDuration: d} = function(e) {
                ...
                function(e, t) {
                    ...
                    e.addEventListener("volumechange", a),
                    a(),
                    n.addEventListener("click", (()=>{
                        e.muted ? (e.muted = !1,
                        e.volume = r) : e.volume = e.volume > 0 ? 0 : r
                    }
                    ))
                }(t, s);
                const {playButton: l, playPause: c} = function(e, t) {
                    let n = !1;
                ...
                t.paused ? h() : v();
                const m = ()=>{
                    t.paused || (l.style.opacity = "1"),
                    s.style.opacity = "1"
                }
                  , g = ()=>{
                    t.paused || (l.style.opacity = "0"),
                    s.style.opacity = "0"
                }
                ;
                a.addEventListener("mouseenter", m),
                a.addEventListener("mouseover", m),
                a.addEventListener("mousemove", m),
                a.addEventListener("mouseleave", g),
                a.addEventListener("mouseout", g),
